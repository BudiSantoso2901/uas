...
def run_moora_app():
    ...
    c_weights = st.text_input("Masukkan Bobot Kriteria (pisahkan dengan koma)", "0.3,0.3,0.1,0.15,0.15")
    ...
    num_criteria = st.number_input("Masukkan Jumlah Kriteria", min_value=1, step=1, value=4)
